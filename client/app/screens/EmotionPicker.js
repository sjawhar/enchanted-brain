      ...
      <View style={styles.container}>
        <View style={styles.emotionChoiceColumn}>
          ...
          <EmotionButton
            ...
            buttonStyle={
              this.state.selected["angry-calm"] === "Very angry" &&
              styles.selected
            }
          />
          <EmotionButton
            ...
            buttonStyle={
              this.state.selected["angry-calm"] === "Somewhat angry" &&
              styles.selected
            }
          />
          <EmotionButton
            ...
            buttonStyle={
              this.state.selected["angry-calm"] === "Neutral" && styles.selected
            }
          />
          <EmotionButton
            title="Somewhat calm"
            ...
            buttonStyle={
              this.state.selected["angry-calm"] === "Somewhat calm" &&
              styles.selected
            }
          />
          <EmotionButton
            ...
            buttonStyle={
              this.state.selected["angry-calm"] === "Very calm" &&
              styles.selected
            }
          />
        </View>
        <View style={styles.emotionChoiceColumn}>
          ...
          <EmotionButton
            ...
            buttonStyle={
              this.state.selected["happy-sad"] === "Very happy" &&
              styles.selected
            }
          />
          <EmotionButton
            ...
            buttonStyle={
              this.state.selected["happy-sad"] === "Somewhat happy" &&
              styles.selected
            }
          />
          <EmotionButton
            ...
            buttonStyle={
              this.state.selected["happy-sad"] === "Neutral" && styles.selected
            }
          />
          <EmotionButton
            title="Somewhat sad"
            ...
            buttonStyle={
              this.state.selected["happy-sad"] === "Somewhat sad" &&
              styles.selected
            }
          />
          <EmotionButton
            ...
            buttonStyle={
              this.state.selected["happy-sad"] === "Very sad" && styles.selected
            }
          />
        </View>
      </View>
